...
describe('Exact 90% Confidence Test with Different SIP Amounts', () => {
  it('should return 90% confidence for Method 1 and Method 2 when networth exactly meets goal with 500 SIP, 10% stretch, and 10% stepup', () => {
    const scenario = createTestScenario(
      'test-goal-90-sip-500',
      'Test Goal 90% Confidence with 500 SIP',
      500,
      10,
      10
    );
  ...
  it('should return 90% confidence for Method 1 and Method 2 when networth exactly meets goal with 2000 SIP, 10% stretch, and 10% stepup', () => {
    const scenario = createTestScenario(
      'test-goal-90-sip-2000',
      'Test Goal 90% Confidence with 2000 SIP',
      2000,
      10,
      10
    );
  ...
  it('should return 90% confidence for Method 1 and Method 2 when networth exactly meets goal with 5000 SIP, 10% stretch, and 10% stepup', () => {
    const scenario = createTestScenario(
      'test-goal-90-sip-5000',
      'Test Goal 90% Confidence with 5000 SIP',
      5000,
      10,
      10
    );
