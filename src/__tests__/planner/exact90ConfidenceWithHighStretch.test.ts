...
describe('Exact 90% Confidence Test with High Stretch SIP', () => {
  it('should return 90% confidence for Method 1 and Method 2 when networth exactly meets goal with 1000 SIP and 20% stretch', () => {
    ...
    // Setup: 1000 SIP, 20% stretch, 0% stepup
  ...
  it('should return 90% confidence for Method 1 and Method 2 when networth exactly meets goal with 1000 SIP and 30% stretch', () => {
    // Setup: Single goal, 5 years horizon
    const goal: Goal = {
